...
{
    /// <summary>
    /// Тест для контроллера <see cref="WorkersController"/>
    /// </summary>
    public class WorkerIntegrationTests : BaseIntegrationTest
    {
        /// <summary>
        /// Инициализирую <see cref="WorkerIntegrationTests"/>
        /// </summary>
        ...
        public async Task PutValueEdit()
        {
            ...
            var targetItem = DataGeneratorApi.EditWorkerRequest();
            targetItem.Id = workerItemAssistant.Id;
            targetItem.ClientId = clientItemNew.Id;
            ...
            // Act
            var response = await clientHTTP.PutAsync($"/Workers", contextData);
            ...
            var workerResult = context.Workers.Single(x => x.Id == targetItem.Id
                                                        && x.Number == targetItem.Number &&
                                                        x.ClientId == targetItem.ClientId);
